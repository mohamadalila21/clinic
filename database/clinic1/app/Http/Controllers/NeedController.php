...
class NeedController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'material'=>'required|string|min:1|max:300',
